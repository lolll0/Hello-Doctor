...
<div  style="cursor: pointer;" onclick="window.open('historyDetail.do?comNo=${history.taNo}','','width=720, height=810, left=500, top=100');return false;" class="timeline-item width330">
                            <div class="row">
